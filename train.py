...
MODEL_MAP = {
    ...
    'ResUnet': ResUnet,
    'Rolling_Unet': Rolling_Unet,
    'UctransUnet': UctransUnet,
    'Unet': Unet,
    'UnetPP': UnetPP,
    'Unext': Unext,
    'Archs1': archs,
...
def parse_args():
    ...
    parser.add_argument('--name', default=archs, help='model name: (default: arch+timestamp)')
    parser.add_argument('--epochs', default=2000, type=int, metavar='N', help='number of total epochs to run')
    parser.add_argument('-b', '--batch_size', default=4, type=int, metavar='N', help='mini-batch size(default: 8)')
    parser.add_argument('--num_workers', default=2, type=int)

    # model
    parser.add_argument('--arch', '-a', metavar='ARCH',
                        default="Rolling_Unet_S")  ### 'Between_Blocks_KNN_Vit'
    parser.add_argument('--deep_supervision', default=False, type=str2bool)
    parser.add_argument('--input_channels', default=3, type=int, help='input channels')
    parser.add_argument('--num_classes', default=1, type=int, help='number of classes')
    parser.add_argument('--input_w', default=256, type=int, help='image width(default: 224)')
    parser.add_argument('--input_h', default=256, type=int, help='image height(default: 224)')
    ...
    # data
    parser.add_argument('--dataset', default='chasedb1', help='dataset name')  ### isic, busi, chasedb1, glas
...
def main():
    ...
    # create model
    model_archs = MODEL_MAP[config['name']]
    model = model_archs.__dict__[config['arch']](num_classes=config['num_classes'],
    ...
    train_img_ids, val_img_ids = train_test_split(img_ids, test_size=0.14, random_state=41)
